 ...
 * *************************
 *    Permet de changer une action en une action neutre. Tous les composants de la structure prennent leur
 * valeur par défaut (sans impact sur le jeu)
 *
 *    Necessite:
 *      - Un pointeur non NULL vers une structure de type action_a_realiser
 *    Garantie:
 *      - action_type vaut: aucune_action
 *      - x_depart et y_depart prennent la valeur -1
 *      - orientation vaut aucune_orientation
 *
 */
 ...
 * *************************
 *    Permet d'initialiser l'action à réaliser en fonction de la ligne de commande entrée par l'utilisateur.
 *
 *    Necessite:
 *      - Un pointeur non NULL vers une chaine de caractères
 *      - Un pointeur non NULL vers une action_a_realiser
 *    Garantie:
 *      - action entrée en commande est realisée
 *
 */
