 ...
 *
 */
int plateau_modification_introduire_piece_etre_possible(const jeu_siam* jeu,type_piece type);
 ...
 *      - Un retour valant 0 sinon.
 */
int plateau_modification_deplacer_piece_etre_possible(const jeu_siam* jeu,int x0,int y0,orientation_deplacement direction_deplacement, orientation_deplacement orientation_finale);
 ...
 */
void plateau_modification_deplacer_piece(jeu_siam* jeu,int x0,int y0,orientation_deplacement deplacement,orientation_deplacement orientation_final);
