 ...
 * *************************
 *    Verifie si les orientations de la piece correspondent à son type
 *    
 *     
 *
 *    Necessite:
 ...
 *    Garantie:
 *      - renvoie 0 si les orientations possibles ne correspondent pas à la piece
 *      - renvoie 1 si les orientations possibles correspondent à la piece
 */
