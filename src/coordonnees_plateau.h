 ...
 * ***************************
 * Permet de deplacer la piece choisie en changeant ses coordonnees sur le plateau
 *
 * Necessite:
 *  - Deux pointeurs int non nuls
 *  - orientation integre (soit haut, bas, gauche, droite)
 * Garantie:
 *  - changement des coordonnees en fronction de l'orientation
 *
 */
