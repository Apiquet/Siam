 ...
 * *************************
 *    Definie le type d'une piece (rocher)

 *    Necessite:
 *      - Un pointeur non NULL vers une piece_siam modifiable.
 *    Garantie:
 *      - Une piece mise a jour avec le nouveau type (rocher).
 *      - La piece doit etre integre.
 */
...
* *************************
*    Definie le type d'une piece (case vide)
*
*    Necessite:
*      - Un pointeur non NULL vers une piece_siam modifiable.
*    Garantie:
*      - Une piece mise a jour avec le nouveau type (case vide).
*      - La piece doit etre integre.
*/
 ...
 * **************************
 * Retourne une piece_siam en fonction de la chaine de caractères envoyée en paramètre
 *
 * Necessite:
 * - Une chaine de caractères.
 * Garantie:
 * - Piece du type et orientation entrés en paramètres
 *
 */
